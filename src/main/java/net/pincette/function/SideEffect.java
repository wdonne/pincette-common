...
/**
 * Allows to interleave statements in expressions. You can run it like
 * this:
 * <p>
 * {@code
 * final int i = SideEffect.<Integer>run(() -> doSomething()).andThenGet(()
 * -> 3);
 * }
 * </p>
 *
...

{
  ...
  /**
   * Runs <code>runnable</code> and then returns a <code>SideEffect</code> on
   * which the <code>andThenGet</code> method can be called.
